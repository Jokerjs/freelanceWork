...
jQuery(function(){
                    ...
                    '<div class="modal-content">' +
                        ...
                        '<div class="modal-body">'+
                            '<div class="btn-group form-group">'+
                                '<button type="button" class="btn btn-default rotateleft"><i class="fa fa-rotate-left"></i>左旋转</button>'+
                                '<button type="button" class="btn btn-default rotateright">右旋转<i class="fa fa-rotate-right"></i></button>'+
                            '</div>' +
                            '<div class="mask-content">'+
                                '<p id="preview">'+
                                    '<img id="preview_img" class="maximg" src="" alt=""></img>'+
                                    '<canvas id="canva" src="" style=""></canvas>'+
                                '</p>'+
                            '</div>' +
                        '</div>'+           
                    '</div>'+
    ...
    function addFile( file ){
        ...
        var lineHeight = thumbnailHeight-10;
        ...
        var $li =   //$('<li data-key="'+file.key+'"  data-src="'+file.src+'" data-sort="'+index+'" draggable="true" id="' + file.id + '" style="position:absolute;margin:0;cursor:move;width:'+thumbnailWidth+'px;height:'+thumbnailHeight+'px;left:'+imgLeft+'px;top:'+imgTop+'">' +
                $(
                    '<li data-key="'+file.key+'"  data-src="'+file.src+'" data-sort="'+index+'" draggable="true" class="file-item thumbnail" id="' + file.id + '" style="width:'+thumbnailWidth+'px;height:'+thumbnailHeight+'px; line-height:'+ lineHeight +'px;" >' +
            ...
            $btns = $(
                ...
                //'<span class="rotateRight">放大</span>'+
                //'<span class="rotateLeft">放大</span>'+
    ...
    function updateStatus(){
        var text = '', stats;
        if( state == 'ready'){
            text = '选中'+fileCount + '张，共'+ WebUploader.formatSize( fileSize ) +'.';
